...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        static readonly Dictionary<
            DOTweenAnimation.AnimationType,
            Type[]
        > _AnimationTypeToComponent = new Dictionary<DOTweenAnimation.AnimationType, Type[]>()
        {
            {
            ...
            {
                DOTweenAnimation.AnimationType.Color,
                new[]
                {
                    typeof(Light),
            ...
            {
                DOTweenAnimation.AnimationType.Fade,
                new[]
                {
                    typeof(Light),
#if true // SPRITE_MARKER
...
#endif
            {
                DOTweenAnimation.AnimationType.PunchPosition,
                new[] {
#if true // UI_MARKER
                    typeof(RectTransform),
#endif
            ...
            {
                DOTweenAnimation.AnimationType.ShakePosition,
                new[] {
#if true // UI_MARKER
                    typeof(RectTransform),
#endif
        ...
        static readonly Dictionary<
            DOTweenAnimation.AnimationType,
            Type[]
        > _TMPAnimationTypeToComponent = new Dictionary<DOTweenAnimation.AnimationType, Type[]>()
        {
            {
                DOTweenAnimation.AnimationType.Color,
                new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) }
            },
            {
                DOTweenAnimation.AnimationType.Fade,
                new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) }
            ...
            {
                DOTweenAnimation.AnimationType.Text,
                new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) }
            },
        };
#endif
...
#pragma warning restore 414
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Label(
                _src.animationType.ToString()
                    + (string.IsNullOrEmpty(_src.id) ? "" : " [" + _src.id + "]"),
            ...
            // Preview in editor
            bool isPreviewing = _settings.showPreviewPanel
                ? DOTweenPreviewManager.PreviewGUI(_src)
                : false;
            ...
            else
            {
                using (
                    new DeGUI.ColorScope(
                        null,
                        null,
                        _src.targetGO == null ? Color.red : Color.white
                    )
                )
                {
                    _src.targetGO = (GameObject)
                        EditorGUILayout.ObjectField(_src.targetGO, typeof(GameObject), true);
                }
            ...
            else
            {
                ...
                if (prevAnimType != _src.animationType)
                {
                    ...
                    switch (_src.animationType)
                    {
                        ...
                        case DOTweenAnimation.AnimationType.Scale:
                            ...
                            _src.optionalBool0 =
                                _src.animationType == DOTweenAnimation.AnimationType.Scale;
                            break;
                        case DOTweenAnimation.AnimationType.UIWidthHeight:
                            _src.endValueV3 = Vector3.zero;
                            _src.endValueFloat = 0;
                            _src.optionalBool0 =
                                _src.animationType == DOTweenAnimation.AnimationType.UIWidthHeight;
                            break;
                        ...
                        case DOTweenAnimation.AnimationType.PunchScale:
                            _src.endValueV3 =
                                _src.animationType == DOTweenAnimation.AnimationType.PunchRotation
                                    ? new Vector3(0, 180, 0)
                                    : Vector3.one;
                        ...
                        case DOTweenAnimation.AnimationType.ShakeScale:
                            _src.endValueV3 =
                                _src.animationType == DOTweenAnimation.AnimationType.ShakeRotation
...
#if true // UI_MARKER
                    if (
                        _src.animationType == DOTweenAnimation.AnimationType.Fade
                        && targetGO.GetComponent<CanvasGroup>() != null
                ...
                {
                    FadeTargetType fadeTargetType = (FadeTargetType)
                        Enum.Parse(typeof(FadeTargetType), _src.forcedTargetType.ToString());
                    DOTweenAnimation.TargetType prevTargetType = _src.forcedTargetType;
                    _src.forcedTargetType = (DOTweenAnimation.TargetType)
                        Enum.Parse(
                            typeof(DOTweenAnimation.TargetType),
                            EditorGUILayout
                                .EnumPopup(_src.animationType + " Target", fadeTargetType)
                                .ToString()
                        );
                ...
                _src.isSpeedBased = DeGUILayout.ToggleButton(
                    ...
                    new GUIContent(
                        "SpeedBased",
                        "If selected, the duration will count as units/degree x second"
                    ),
                ...
                if (_src.delay < 0)
                    _src.delay = 0;
                _src.isIndependentUpdate = EditorGUILayout.Toggle(
                    "Ignore TimeScale",
                    _src.isIndependentUpdate
                );
                ...
                if (_src.loops > 1 || _src.loops == -1)
                    _src.loopType = (LoopType)
                        EditorGUILayout.EnumPopup("   Loop Type", _src.loopType);
                ...
                switch (_src.animationType)
                {
                    ...
                    case DOTweenAnimation.AnimationType.LocalMove:
                        GUIEndValueV3(
                            targetGO,
                            _src.animationType == DOTweenAnimation.AnimationType.Move
                        );
                        _src.optionalBool0 = EditorGUILayout.Toggle(
                            "    Snapping",
                            _src.optionalBool0
                        );
                    ...
                    case DOTweenAnimation.AnimationType.LocalRotate:
                        ...
                        else
                        {
                            ...
                            _src.optionalRotationMode = (RotateMode)
                    ...
                    case DOTweenAnimation.AnimationType.Text:
                        ...
                        _src.optionalScrambleMode = (ScrambleMode)
                            EditorGUILayout.EnumPopup("Scramble Mode", _src.optionalScrambleMode);
                    ...
                    case DOTweenAnimation.AnimationType.ShakeScale:
                        ...
                        using (new GUILayout.HorizontalScope())
                        {
                            ...
                            _src.optionalShakeRandomnessMode = (ShakeRandomnessMode)
                                EditorGUILayout.EnumPopup(
        ...
        void GUIEndValueV3(GameObject targetGO, bool optionalTransform = false)
        {
            ...
            if (_src.useTargetAsV3)
            {
                ...
                _src.endValueTransform =
                    EditorGUILayout.ObjectField(_src.endValueTransform, typeof(Transform), true)
                    as Transform;
            ...
            {
                _src.endValueV3 = EditorGUILayout.Vector3Field(
                    "",
                    _src.endValueV3,
                    GUILayout.Height(16)
                );
        ...
        void GUIEndValueV2()
        {
            GUILayout.BeginHorizontal();
            GUIToFromButton();
            _src.endValueV2 = EditorGUILayout.Vector2Field(
                "",
                _src.endValueV2,
                GUILayout.Height(16)
            );
        ...
        void GUIEndValueString()
        {
            GUILayout.BeginHorizontal();
            GUIToFromButton();
            _src.endValueString = EditorGUILayout.TextArea(
                _src.endValueString,
                EditorGUIUtils.wordWrapTextArea
            );
            GUILayout.EndHorizontal();
        }
    ...
    static class Initializer
    {
        ...
        static void OnReset(DOTweenAnimation src)
        {
            ...
            src.autoPlay =
                settings.defaultAutoPlay == AutoPlay.All
